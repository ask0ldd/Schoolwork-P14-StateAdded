...
function OptionsList(){
    ...
    return(
        listbox.isExpanded ? 
        <ul onClick={(e) => {e.preventDefault(); console.log('listbox');}} tabIndex={-1} id="customListbox" aria-labelledby="customSelectLabel" className="selectOptionsContainer" role="listbox">
